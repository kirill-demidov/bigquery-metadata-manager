...
✅ Реализовано: API ключ OpenAI хранится в Secret Manager GCP под именем `analytics_table_desc_ai_creator` и автоматически подключается при деплое через Cloud Build.
