...
Проект включает веб-интерфейс для просмотра и редактирования описаний таблиц и колонок прямо в браузере.

### Возможности веб-интерфейса:

- 📋 Просмотр всех таблиц с описаниями
- 🔍 Поиск по таблицам и колонкам
- ✏️ Редактирование описаний таблиц
- ✏️ Редактирование описаний колонок
- 💾 Автоматическое сохранение в мета-таблицы и BigQuery схему
...
```bash
# Убедитесь, что у вас настроен Application Default Credentials для BigQuery
...
1. **Cloud Run Job** — фоновый процесс для автоматической генерации метаданных (`main.py`)
2. **Cloud Run Service** — веб-интерфейс для просмотра и редактирования (`web_app.py`)
